...
public class FlightDetailsInfo {
	...
	public FlightDetailsInfo(Integer id, Integer flightNumber, String operatingAirlines, String fromPlace,
	...
	public String toString() {
		return "FlightDetailsInfo [id=" + id + ", flightNumber=" + flightNumber + ", operatingAirlines="
				...
				+ ", endDate=" + endDate + ", scheduleDays=" + Arrays.toString(scheduleDays) + ", businessSeats="
				+ businessSeats + ", nonBusinessSeats=" + nonBusinessSeats + ", cost=" + cost + ", dateOfDeparture="
				+ dateOfDeparture + "]";
	}
